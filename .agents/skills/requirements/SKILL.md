...
2. Read `docs/features/INDEX.md` to see existing features.
...
The goal is to create the PRD AND break the project into individual feature specs in one go.
...
- Save to `docs/features/PROJ-X-feature-name.md`
- Include user stories, acceptance criteria, and edge cases
- Document dependencies on other features

### Phase 5: Update Tracking
- Update `docs/features/INDEX.md` with all new features and their statuses
...
> - PRD at `docs/PRD.md`
> - X feature specs in `docs/features/`
>
> Recommended first feature: PROJ-1 ([feature name])
> Next step: Run `architecture skill` to design the technical approach for PROJ-1."

### Init Mode Git Commit
```
feat: Initialize project
- PRD and X feature specifications
...
- Create the spec in `docs/features/PROJ-X-feature-name.md`
- Assign the next available PROJ-X ID from `docs/features/INDEX.md`
...
### Phase 5: Update Tracking
- Add the new feature to `docs/features/INDEX.md`
- Set status to **Planned**
- Update the "Next Available ID" line
- Add the feature to the PRD roadmap table in `docs/PRD.md`

### Feature Mode Handoff
> "Feature spec is ready! Next step: Run `architecture skill` to design the technical approach for this feature."
...
- [ ] `docs/features/INDEX.md` updated with all features
...
- [ ] File saved to `docs/features/PROJ-X-feature-name.md`
