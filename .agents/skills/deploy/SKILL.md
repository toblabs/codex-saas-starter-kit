...
## Before Starting
1. Read `docs/features/INDEX.md` to know what is being deployed.
2. Check QA status in the feature spec.
3. Verify that no Critical or High bugs exist in QA results.
4. If QA has not been done, tell the user to run `qa skill` first.
...
- Update feature spec with deployment URL and date
- Update `docs/features/INDEX.md` to **Deployed**
...
- [ ] `docs/features/INDEX.md` updated to Deployed
